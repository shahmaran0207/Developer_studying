        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                    ...
                    <h3>지역 선택</h3>
                    <p class="lead mb-0">여행을 가고자 하는 지역을 선택해주세요!<br></p>
                    <select style="font-size: 20px">
                        <option>어디 지역에 여행을 갈지 선택해주세요
                        <option id="areagangwon">강원도
                        <option id="areagyeonggi">경기도
                        <option id="areagyeongnam">경상남도
                        <option id="areagyeongbuk">경상북도
                        <option id="areagwangju">광주광역시
                        <option id="areadaegu">대구광역시
                        <option id="areadaejeon">대전광역시
                        <option id="areabusan">부산광역시
                        <option id="areaseoul">서울특별시
                        <option id="areaulsan">울산광역시
                        <option id="areaincheon">인천광역시
                        <option id="areajeunnam">전라남도
                        <option id="areajeunbuk">전라북도
                        <option id="areajeju">제주특별자치도
